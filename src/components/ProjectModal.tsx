        ...
        <div className="py-5 space-y-6">
          ...
          <div>
            <div className="flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-[#ffb1c3] font-semibold mb-2">
              <span className="w-1.5 h-1.5 rounded-full bg-[#ffb1c3]"></span>
              <span>PROBLEM</span>
            </div>
            <div className="p-3.5 rounded-xl bg-[#11121f] border border-[#282936] text-xs sm:text-sm text-[#cbc3d5] font-light leading-relaxed">
              {problemText}
            </div>
          </div>
          ...
          <div className="p-4 sm:p-5 rounded-xl bg-gradient-to-br from-[#1b1c2b] to-[#141524] border border-[#cfbdff]/30 shadow-md">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
              ...
              <div className="p-2.5 rounded-lg bg-[#0c0d19]/80 border border-[#282936]">
                <div className="text-[10px] font-mono uppercase tracking-wider text-[#948e9e]">TEAM</div>
            ...
            {/* Team Context clarification if team project */}
            {teamContext && (
              <div className="mt-3 pt-3 border-t border-[#282936] text-[11px] text-[#948e9e] italic">
          ...
          {project.features && project.features.length > 0 && (
            <div>
              <div className="flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-[#cfbdff] font-semibold mb-2">
                <span className="w-1.5 h-1.5 rounded-full bg-[#cfbdff]"></span>
          ...
          <div>
            <div className="flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-[#948e9e] font-semibold mb-2">
              <span className="w-1.5 h-1.5 rounded-full bg-[#948e9e]"></span>
            ...
            <div className="flex flex-wrap gap-2">
              {project.tags.map((tag) => (
                <span
                  key={tag}
                  className="px-3 py-1 rounded-lg bg-[#11121f] text-xs text-[#cfbdff] border border-[#333441] font-mono"
                >
                  {tag}
                </span>
              ))}
          ...
          <div className="p-4 sm:p-5 rounded-xl bg-[#11121f] border border-[#333441]">
            <div className="flex items-center justify-between pb-3 border-b border-[#282936] mb-3">
              ...
              <span className="text-[11px] text-[#948e9e] font-mono">Recruiter Verification</span>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-2.5">
              {hasGithub && githubHref && (
                <a
                  ...
                  className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg bg-[#282936] hover:bg-[#373846] border border-[#494553] text-[#e2e1f3] hover:text-[#cfbdff] text-xs font-medium transition-colors"
                >
              ...
              {hasLiveDemo && liveDemoHref ? (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg bg-[#66d9ca]/20 hover:bg-[#66d9ca]/30 border border-[#66d9ca]/40 text-[#66d9ca] text-xs font-semibold transition-colors"
                >
                  <span>Live Demo ↗</span>
                </a>
              ) : (
                <span className="px-3 py-2 rounded-lg bg-[#1d1f2b] border border-[#282936] text-[11px] text-[#948e9e] font-mono">
